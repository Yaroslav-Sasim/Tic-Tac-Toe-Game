    ...
    public partial class Form4 : Form
    {
        ...
        private void checkFormWinner()
        {
            ...
            if ((A1.Text == A2.Text) && (A2.Text == A3.Text) && (A3.Text == A4.Text) && (!A1.Enabled))
                ...
                there_is_a_winner = true;
            else if ((E1.Text == E2.Text) && (E2.Text == E3.Text) && (E3.Text == E4.Text) && (!E1.Enabled))
                there_is_a_winner = true;
            //вертикально
            else if ((A1.Text == B1.Text) && (B1.Text == C1.Text) && (C1.Text == E1.Text) && (!A1.Enabled))
                there_is_a_winner = true;
            else if ((A2.Text == B2.Text) && (B2.Text == C2.Text) && (C2.Text == E2.Text) && (!A2.Enabled))
                there_is_a_winner = true;
            else if ((A3.Text == B3.Text) && (B3.Text == C3.Text) && (C3.Text == E3.Text) && (!A3.Enabled))
                there_is_a_winner = true;
            else if ((A4.Text == B4.Text) && (B4.Text == C4.Text) && (C4.Text == E4.Text) && (!A4.Enabled))
                there_is_a_winner = true;
            //диагональ 
            else if ((A1.Text == B2.Text) && (B2.Text == C3.Text) && (C3.Text == E4.Text) && (!A1.Enabled))
                there_is_a_winner = true;
            else if ((A4.Text == B3.Text) && (B3.Text == C2.Text) && (C2.Text == E1.Text) && (!E1.Enabled))
                there_is_a_winner = true;
